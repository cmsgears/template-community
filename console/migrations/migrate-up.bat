...
call ../../yii migrate/up --migrationPath=@cmsgears/module-community/migrations --interactive=0
call ../../yii migrate/up --migrationPath=@themes/community/migrations --interactive=0
