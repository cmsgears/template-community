...
return [
	...
	'bootstrap' => [
		'log',
		'core', 'cms', 'forms', 'snsConnect', 'newsletter', 'notify', 'community',
		'foxSlider'
	],
	'modules' => [
		'core' => [
	...
	'components' => [
		...
		'request' => [
			'csrfParam' => '_csrf-cmg-community-site',
			'parsers' => [
				'application/json' => 'yii\web\JsonParser'
			]
		],
		'user' => [
			'identityCookie' => [ 'name' => '_identity-cmg-community-site', 'httpOnly' => true ]
		],
		'session' => [
			'name' => 'cmg-community-site'
		],
		'errorHandler' => [
